...
cmd({
    ...
    try {
        ...
        const { data: zipData } = await axios.get("https://github.com/darkashenxmd/Dark-ashen-xmd/archive/main.zip", { responseType: "arraybuffer" });
        ...
        const sourcePath = path.join(extractPath, "Dark-ashen-xmd-main");
